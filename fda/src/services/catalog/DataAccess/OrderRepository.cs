...
namespace catalog.DataAccess
{
    public class OrderRepository : MongoRepository<Order>
    {
        ...
        public IEnumerable<Order> GetByRestaurantId(string restaurantId)
        {
        ...
        public IEnumerable<Order> GetByStatus(string restaurantId, OrderStatus status)
        {
        ...
        public IEnumerable<Order> GetPendingOrders(string restaurantId)
        {
            return _collection.Find(order => 
                order.RestaurantId == restaurantId && 
        ...
        public IEnumerable<Order> GetReadyForPickup(string restaurantId)
        {
            return _collection.Find(order => 
                order.RestaurantId == restaurantId && 
        ...
        public new void Update(string id, Order entity)
        {
