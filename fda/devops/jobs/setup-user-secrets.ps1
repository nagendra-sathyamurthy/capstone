...
function Set-ServiceSecrets {
    ...
    if (Test-Path $ServicePath) {
        ...
        try {
            ...
            dotnet user-secrets set "ConnectionStrings:DefaultConnection" "mongodb://admin:AdminPass2024@localhost:30000/${Database}?authSource=admin"
            dotnet user-secrets set "DatabaseSettings:ConnectionString" "mongodb://admin:AdminPass2024@localhost:30000/${Database}?authSource=admin"
